...
Member, <a href="https://biox.stanford.edu/">Bio-X</a> · Faculty Affiliate, <a href="https://hai.stanford.edu/">HAI</a> · Member, <a href="https://neuroscience.stanford.edu/">Wu Tsai Neurosciences Institute</a>
</div>
...
Training a model of this scale demands computational resources that go far beyond what a typical university lab can access. The 80B-parameter architecture requires coordinated training across hundreds of GPUs communicating at high bandwidth. This is exactly the kind of capability-scale workload that Marlowe was built for.
