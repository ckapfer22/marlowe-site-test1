...
Professor Dan Yamins' team completed a landmark proof-of-concept run on Marlowe, training an 80-billion-parameter brain-inspired neural network across 24 nodes (192 H100 GPUs) for 24 hours. The run achieved 45% model FLOPS utilization (MFU), validating that capability-scale computational neuroscience training is possible on Stanford's GPU supercomputer.
